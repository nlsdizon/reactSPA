    ...
    render() {
        ...
        return(
            <div className="container mt-4">
                    ...
                    <div className="card bg-light mb-4">
                        <div className="input-group input-group-lg">
                            ...
                            <div className="input-group-append">
                                <button className="btn btn-sm btn-info btn-outline-secondary" title="Reset Search" onClick={() => this.chooseRandom() }>
                                    <FaRandom />
                                </button>
                                <button className="btn btn-sm btn-info btn-outline-secondary" title="Reset Search" onClick={() => this.resetQuery() }>
                                    <FaUndo />
                                </button>
                            </div>
                        </div>
                ...
                <AttendeesList meetingID={this.props.meetingID} adminUser={this.props.adminUser} userID={this.props.userID} attendees={filteredAttendees}/>
            </div>
        )
    }
};
